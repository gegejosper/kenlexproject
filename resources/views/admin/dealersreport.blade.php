              ...
              <div class="widget-content">
                <table class="table table-striped table-bordered">
                  ...
                  <?php $totalamountDealers= 0;?>
                    @foreach($reportDealerspackageorder as $Dealers)
                    <?php $totalamountDealers = $totalamountDealers + $Dealers->packageprice; ?>
                    <tr>
                    <td align="center" style="text-align:center">{{$Dealers->created_at}}</td>
                      <td>{{$Dealers->ordernumber}}</a></td>

                      <td>{{$Dealers->dealer->fname}} {{$Dealers->dealer->lname}}</td>
                      <td>{{number_format($Dealers->packageprice,2)}}</em>  </td>
                      </tr>
                    @endforeach
