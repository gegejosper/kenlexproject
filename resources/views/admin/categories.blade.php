              ...
              <table class="table table-striped table-bordered" id="table">
                ...
                <tbody>
                  ...
                  <tr class="item{{$Category->id}}">
                    ...
                    <td class="td-actions"><a href="javascript:;" class=" edit-modal btn btn-small btn-success" data-id="{{$Category->id}}" data-name="{{$Category->cat_name}}"><i class="btn-icon-only icon-pencil"> </i></a><a href="javascript:;" class="delete-modal btn btn-danger btn-small" data-id="{{$Category->id}}" data-name="{{$Category->cat_name}}"><i class="btn-icon-only icon-remove"> </i></a></td>
