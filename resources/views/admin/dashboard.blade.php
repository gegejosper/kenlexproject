...
@section('content')
 <div class="main">
  <div class="main-inner">
    <div class="container">
    <div class="row">
    <div class="span6"> <!-- Recent Bookings -->
        <div class="widget widget-table action-table">
            <div class="widget-header"> <i class="icon-th-list"></i>
              <h3>Recent Transactions</h3>
              <div style="float:right; padding-right:10px;"><a href="/admin/report" type="button" class="btn btn-info btn-small" >+ View More</a></div>
            </div>
            <!-- /widget-header -->
      ...
      <div class="row">
        ...
        <div class="widget widget-table action-table">
            <div class="widget-header"> <i class="icon-th"></i>
              <h3>Warehouse Stocks Summary</h3>
              <div style="float:right; padding-right:10px;"><a href="/admin/purchase" type="button" class="btn btn-warning btn-small">+ Create Purchase Request</a></div>
            </div>
            <!-- /widget-header -->
            <div class="widget-content">
            <table class="table table-striped table-bordered">
