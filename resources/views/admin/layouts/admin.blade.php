  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li><a href="/admin/packages"><i class="icon-qrcode" aria-hidden="true"></i><span>Packages</span> </a></li>
        
        <li><a href="/admin/purchase"><i class="icon-folder-open" aria-hidden="true"></i><span>Purchases</span> </a></li>
