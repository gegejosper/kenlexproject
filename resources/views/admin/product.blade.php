                                ...
                                <div class="control-group padding-20">	
                                    <table class="table table-striped table-bordered" id="table">
                                        ...
                                        <tr class="item{{$Productquantity->id}}">
                                            ...
                                            <td> <a href="/admin/branchs/{{$Productquantity->branch_id}}" class="name">{{$Productquantity->branch->branch_name}}</a> </td>
                                            <td>{{$Productquantity->quantity}}</td>
                                            <td style="width:100px;" class="td-actions"><a href="/admin/branchs/{{$Productquantity->branch_id}}" class="btn btn-mini btn-info" ><i class="icon-search"> </i></a></td>
