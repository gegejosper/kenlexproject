      ...
      <div class="row">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                  ...
                  <td align="center" style="text-align:center" width="100px"> <a href="#" class="avatar"><img src="{{ asset('productimg') }}/{{$Product->pic}}" width="50px"/></a> </td>
                    <td style="width:100px;"><a href="/admin/products/{{$Product->id}}">{{$Product->product_name}}</a></td>
        ...
        <div class="widget widget-table action-table">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                  @foreach($dataBranchProduct as $Productquantity)
                  ...
                  <td align="center" style="text-align:center" width="100px"> <a href="#" class="avatar"><img src="{{ asset('productimg') }}/{{$Productquantity->product->pic}}" width="50px"/></a> </td>
                    <td style="width:100px;"><a href="/admin/products/{{$Productquantity->prod_id}}">{{$Productquantity->product->product_name}}</a></td>
                    <td>{{$Productquantity->quantity}}</td>
                    <td>{{$Productquantity->price}}</td>
                    
                    
                    <td style="width:100px;" class="td-actions"><a href="/admin/products/{{$Productquantity->prod_id}}" class="edit-modal btn btn-mini btn-info"  ><i class="icon-search"> </i>View</a> </td>
