            ...
            <div class="widget widget-nopad">
                ...
                <div class="widget big-stats-container">
                    ...
                    <div id="big_stats" class="cf">
                        ...
                        <form enctype="multipart/form-data" action="{{ route('addpackages') }}" method="post">
                        {{ csrf_field() }}    
                        
                            <label for="Product Name">Package Name</label>
                            <input type="text" class="form-control" placeholder="Package Name"  name="packagename">
                            <label class="control-label" for="Description">Description</label>
                                ...
                                <div class="control-group">											
                                    ...
                                    <input type="number" class="form-control" placeholder="Package Price"  name="packageprice">      
								</div> 
