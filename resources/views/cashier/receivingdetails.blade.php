      ...
      <div class="row">
        ...
        <div class="widget widget-table action-table" >
            <div class="widget-header" style="padding-bottom:10px;"> <i class="icon-sitemap"></i>
              <h3>Distribution # <strong></strong></h3>   
            </div>
            <!-- /widget-header -->
            <div class="widget-content">
            <table class="table table-striped table-bordered">
                        ...
                        @foreach($dataDistributionrecord as $Record)
                            <tr>
                                ...
                                if($Record->status == 0)
                                {
                                ?><a href="javascript:;" class="edit-modal btn btn-mini btn-default" data-id="{{$Record->id}}" ><i class="icon-plus"> </i> Add Quantity</a> 
                                <?php 
                                }
                                else {
                                ?>
...
<script src="{{ asset('js/receivingdetailscript.js') }}"></script>
<!-- /main -->
@endsection