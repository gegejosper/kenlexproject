      ...
      $('.modal-footer').on('click', '.edit', function() {
          ...
          $.ajax({
              ...
              success: function(data) {
                  $('.item' + data.id).replaceWith("<tr class='item" + data.id + "'><td>" + data.cat_name + "</td><td class='td-actions'><button class='edit-modal btn btn-small btn-success' data-id='" + data.id + "' data-name='" + data.cat_name + "'><i class='btn-icon-only icon-pencil'> </i></button><a class='delete-modal btn btn-danger btn-small' data-id='" + data.id + "' data-name='" + data.cat_name + "'><i class='btn-icon-only icon-remove'> </i></a></td></tr>");
                  console.log("sucess");
                }
          });
      });
