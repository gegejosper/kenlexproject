...
class PackageController extends Controller
{
    ...
    public function packageorder($packageid){
        ...
        $dataPackage = Packagebranch::where('packageid', '=', $packageid)->where('branchid', '=', $dataBranch->branch_id)->with('package')->get();
        //dd($dataBranchID);
        return view('cashier.packageorder', compact('dataPackage', 'dataPackageItem','packageid', 'dataBranchID'));
    }
...
return response()->json($orderData);
    ...
    public function packageprocesssuccess($boxid){
        ...
        $dataCustomer = Customer::where('boxId','=',$boxid)
                                        ->first(); 
        $name = $dataCustomer->fname + " &nbsp; " + $dataCustomer->fname;
        ...
        return view('cashier.packageprocesssuccess', compact('dataPackageOrder','name','packageName','price'));
    }
    ...
    // public function packagedealerprocesssuccess($dealerid, $ordernumber){
    //     $dataPackageOrder = Dealerspackageorder::where('dealerid','=',$dealerid)
    //                                     ->where('ordernumber','=',$ordernumber)
    //                                     ->first();
    //     $dataDealer = Dealer::where('id','=',$dealerid)
    //                                     ->first(); 
    //     $name = $dataDealer->fname + " &nbsp; " + $dataDealer->fname;
    //     $dataPackage = Package::where('id','=',$dataPackageOrder->packageid)
    //                             ->first();  
    //     $packageName = $dataPackage->packagename;
    //     $price = $dataPackageOrder->packageprice;
    //     return view('cashier.packagenewdealerprocesssuccess', compact('dataPackageOrder','name','packageName','price'));
    // }
}
