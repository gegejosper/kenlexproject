...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('home', compact('dataProduct','dataBrand','dataCategory','dataBranch','dataSupplier', 'dataProductquantity','dataTags','userId'));
        //return view('home');
    ...
    public function slug($slug)
    {
        ...
        $dataCategory = Category::all();
        $dataTags = Tagging_tag::all();
        return view('tag', compact('dataCategory', 'dataProductquantity','dataTags', 'dataBrand','userId'));
        //return view('home');
    ...
    public function category($id)
    {
        ...
        $dataCategory = Category::all();
        $dataTags = Tagging_tag::all();
        return view('category', compact('dataCategory', 'dataProductquantity','dataTags', 'dataBrand', 'userId'));
    }
    public function brand($id)
    {
        ...
        $dataCategory = Category::all();
        $dataTags = Tagging_tag::all();
        return view('brand', compact('dataCategory', 'dataProductquantity','dataTags', 'dataBrand','userId'));
    }
    public function shop()
    {
        ...
        $dataSupplier = Supplier::all();
        $dataTags = Tagging_tag::all();
        return view('shop', compact('dataProduct','dataBrand','dataCategory','dataBranch','dataSupplier', 'dataProductquantity','dataTags','userId'));
    }
