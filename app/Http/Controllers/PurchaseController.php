...
class PurchaseController extends Controller
{
    ...
    public function recievequantity(Request $request)
    {
            ...
            //$dataPurchaserecord = Purchaserecord::find($request->requestid);
    ...
    public function createpurchaserequest($purchasenumber)
    {
    ...
    public function readPurchase(Request $req)
    {
        ...
        return view('admin.purchase',compact('data','dataUser','dataProductquantity', 'dataPurchase', 'dataProduct', 'dataPurchaserequest'));    
    }
